...
def map_table_ohlc(register: registry, table_name: str) -> Table:
    return Table(
      ...
      Column('asset', Text, primary_key=True, nullable=False),
      Column('symbol', Text, primary_key=True, nullable=False),
      Column('resolution', Integer, primary_key=True, nullable=False),
      Column('ts_datetime', DateTime, primary_key=True, nullable=False),
